...
namespace Repositories.Models
{
    public partial class PropertyContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=.;Database=Property;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Location>(entity =>
            {
                ...
                entity.HasOne(d => d.LocationOwnerNavigation)
                    .WithMany(p => p.Location)
                    .HasForeignKey(d => d.LocationOwner)
            ...
            modelBuilder.Entity<Person>(entity =>
            {
                ...
                entity.Property(e => e.PersonTelephone)
                    .IsRequired()
                    .HasMaxLength(50);
            });
